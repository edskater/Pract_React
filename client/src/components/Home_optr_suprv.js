...
//<div> {/* {userRole === 'admin' ? HomeAdmin : HomeOperadorSupervisor} */} </div>
...
export default function HOME(){
  return(
   ...
   <Container>
     ...
     <CardActions>
       <Button variant="contained" size="large" sx={{backgroundColor: 'black', borderRadius: '21.5px'}} href='/Registro_Nv'>Iniciar Registro</Button>
     </CardActions>
   </Card>

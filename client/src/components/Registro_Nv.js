...
import { TextField, Select, MenuItem, FormControl, InputLabel, Switch, FormControlLabel, Box, Container, Grid,  } from '@mui/material';
...
export default function RegistrationForm() {
  ...
  return (
        ...
        <Container>
                <Box height={'74vh'} flexDirection="column"  display={'flex'} > 
